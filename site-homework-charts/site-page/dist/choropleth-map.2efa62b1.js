...
module.exports = "/counties.af7d2c40.topojson";
},{}],"scripts/choropleth-map.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#choropleth-map').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
var projection = d3.geoAlbers();
var colorScale = d3.scaleSequential(d3.interpolatePiYG).domain([0, 1]);
var opacityScale = d3.scaleLinear().domain([0, 50000]).range([0, 1]).clamp(true); // out geoPath needs a PROJECTION variable
...
function ready(json) {
  ...
  svg.append('g').selectAll('.country').data(counties.features).enter().append('path').attr('class', 'county').attr('d', path).attr('fill', function (d) {
    var total = d.properties.OBAMA + d.properties.ROMNEY;
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","/data/counties.topojson":"data/counties.topojson"}]},{},["scripts/choropleth-map.js"], null)
//# sourceMappingURL=/choropleth-map.2efa62b1.js.map