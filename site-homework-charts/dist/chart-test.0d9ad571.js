...
},{}],"scripts/chart-test.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#chart-test').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // Create your scales

var xPositionScale = d3.scaleLinear().domain([170, 230]).range([0, width]);
var yPositionScale = d3.scaleLinear().domain([60, 160]).range([height, 0]);
var colorScale = d3.scaleOrdinal().range(['orange', 'green', 'blue', 'purple', 'yellow']);
var radiusScale = d3.scaleSqrt().domain([0, 700]).range([1, 8]); // Import your data file
...
function ready(datapoints) {
  ...
  console.log(nested);
  svg.selectAll('circle').data(datapoints).enter().append('circle').attr('r', function (d) {
  ...
  }).attr('opacity', 0.3); // Add your axes
...
},{"d3":"../node_modules/d3/index.js","../data/player_stats.csv":"data/player_stats.csv"}]},{},["scripts/chart-test.js"], null)
//# sourceMappingURL=/chart-test.0d9ad571.js.map